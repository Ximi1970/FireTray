...
var { firetray } = ChromeUtils.import("chrome://firetray/content/modules/FiretrayMessaging.jsm");
var { firetray } = ChromeUtils.import("chrome://firetray/content/modules/"+Services.appinfo.OS.toLowerCase()+"/FiretrayChat.jsm");
