...
var { ctypesMap,
      ...
      DeleteError
    } = ChromeUtils.import("chrome://firetray/content/modules/ctypes/ctypesMap.jsm");
...
var { x11,
      ...
      XATOMS
    } = ChromeUtils.import("chrome://firetray/content/modules/ctypes/linux/x11.jsm");
...
var { firetray } = ChromeUtils.import("chrome://firetray/content/modules/linux/FiretrayChat.jsm");
var { firetray } = ChromeUtils.import("chrome://firetray/content/modules/linux/FiretrayChatStatusIcon.jsm");
...
firetray.Window.getGtkWindowFromChromeWindow = function(window) {
  let baseWindow = window.getInterface(Ci.nsIWebNavigation)
