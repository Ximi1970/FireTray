...
var { gdk } = ChromeUtils.import("chrome://firetray/content/modules/ctypes/linux/"+FIRETRAY_GTK+"/gdk.jsm");
var { gio } = ChromeUtils.import("chrome://firetray/content/modules/ctypes/linux/gio.jsm");
...
var { libc } = ChromeUtils.import("chrome://firetray/content/modules/ctypes/linux/libc.jsm");
var { x11 } = ChromeUtils.import("chrome://firetray/content/modules/ctypes/linux/x11.jsm");
var { appind } = ChromeUtils.import("chrome://firetray/content/modules/ctypes/linux/"+FIRETRAY_GTK+"/appindicator.jsm");
//MR firetray.Handler.subscribeLibsForClosing([gdk, gio, glib, gobject]);
var { firetray } = ChromeUtils.import("chrome://firetray/content/modules/linux/FiretrayAppIndicator.jsm");
var { firetray } = ChromeUtils.import("chrome://firetray/content/modules/linux/FiretrayGtkStatusIcon.jsm");
var { firetray } = ChromeUtils.import("chrome://firetray/content/modules/linux/FiretrayPopupMenu.jsm");
...
firetray.StatusIcon = {
  ...
  canAppind: function() {
    return (appind.available() && this.dbusNotificationWatcherReady());
  },
